...
const textareaVariants = cva(
  "placeholder:text-muted-foreground focus-visible:ring-ring/50 flex field-sizing-content w-full text-base shadow-xs transition-[color,box-shadow] outline-none disabled:cursor-not-allowed disabled:opacity-50 md:text-sm",
  {
    variants: {
      variant: {
        default:
